...
<html lang="en">
    <head>
        ...
        <title>DocAppoint - Harsh Thakkar Project (1959894) - Dashboard</title>
										...
										<a href="#">
											<div class="media">
												...
												<div class="media-body">
													<p class="noti-details"><span class="noti-title">Dr. Harsh Thakkar</span> Schedule <span class="noti-title">her appointment</span></p>
									...
									<li class="notification-message">
										<a href="#">
											<div class="media">
												...
												<div class="media-body">
													<p class="noti-details"><span class="noti-title">Prince Aggarwal</span> has booked her appointment to <span class="noti-title">Dr. Harsh Thakkar</span></p>
									...
									<li class="notification-message">
										<a href="#">
											<div class="media">
												...
												<div class="media-body">
												<p class="noti-details"><span class="noti-title">Narendra Modi</span> sent a amount of $210 for his <span class="noti-title">appointment</span></p>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.php">Dr. Harsh Thakkar</a>
														</h2>
													</td>
													<td>Dental</td>
													<td>$3200.00</td>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.php">Prince Aggarwal </a>
														</h2>
													</td>
													<td>8286329170</td>
													<td>20 Oct 2019</td>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.php">Narendra Modi </a>
														</h2>
													</td>
													<td>2077299974</td>
													<td>22 Oct 2019</td>
