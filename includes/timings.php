													...
													<div class="col-lg-4">
														<div class="form-group">               
															...
															<select class="select form-control select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
																...
																<option selected="selected" data-select2-id="3">30 mins</option>  
																<option>45 mins</option>
																<option>1 Hour</option>
															</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-ff7l-container"><span class="select2-selection__rendered" id="select2-ff7l-container" role="textbox" aria-readonly="true" title="30 mins">30 mins</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
														</div>
													</div>
