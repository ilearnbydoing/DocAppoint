						...
						<div class="doctor-slider slider">
							...
							<div class="profile-widget">
								...
								<div class="pro-content">
									...
									<ul class="available-info">
										<li>
											<i class="fas fa-map-marker-alt"></i> Montreal, CA
										</li>
										<li>
											<i class="far fa-clock"></i> Available on Fri, 22 Mar
										</li>
							...
							<div class="profile-widget">
								...
								<div class="pro-content">
									...
									<ul class="available-info">
										<li>
											<i class="fas fa-map-marker-alt"></i> Quebec City, CA
										</li>
										<li>
											<i class="far fa-clock"></i> Available on Fri, 22 Mar
										</li>
							...
							<div class="profile-widget">
								...
								<div class="pro-content">
									...
									<ul class="available-info">
										<li>
											<i class="fas fa-map-marker-alt"></i> Louisiana, CA
										</li>
										<li>
											<i class="far fa-clock"></i> Available on Fri, 22 Mar
										</li>
							...
							<div class="profile-widget">
								...
								<div class="pro-content">
									...
									<ul class="available-info">
										<li>
											<i class="fas fa-map-marker-alt"></i> Michigan, CA
										</li>
										<li>
											<i class="far fa-clock"></i> Available on Fri, 22 Mar
										</li>
							...
							<div class="profile-widget">
								...
								<div class="pro-content">
									...
									<ul class="available-info">
										<li>
											<i class="fas fa-map-marker-alt"></i> Brampton, CA
										</li>
										<li>
											<i class="far fa-clock"></i> Available on Fri, 22 Mar
										</li>
							...
							<div class="profile-widget">
								...
								<div class="pro-content">
									...
									<ul class="available-info">
										<li>
											<i class="fas fa-map-marker-alt"></i> Hamilton, CA
										</li>
										<li>
											<i class="far fa-clock"></i> Available on Fri, 22 Mar
										</li>
