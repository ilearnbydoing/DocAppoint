								...
								<ul class="entry-meta meta-item">
									<li>
										<div class="post-author">
											<a href="doctor-profile.php"><img src="assets/img/doctors/doctor-thumb-01.jpg" alt="Post Author"> <span>Dr. Harsh Thakkar</span></a>
										</div>
									</li>
									<li><i class="far fa-clock"></i> 4 Dec 2019</li>
								</ul>
								<h3 class="blog-title"><a href="blog-details.php">DocAppoint – Making your clinic painless visit?</a></h3>
