...
$charge = \Stripe\Charge::create(['amount' => 2000, 'currency' => 'cad', 'source' => 'tok_189fqt2eZvKYlo2CTGBeg6Uq']);
echo $charge;
```
...
```php
$charge = \Stripe\Charge::create(['amount' => 2000, 'currency' => 'cad', 'source' => 'tok_visa']);
