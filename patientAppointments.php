								...
								<div class="card-body pt-0">
									...
									<nav class="user-tabs mb-4">
										<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
											<li class="nav-item">
												<a class="nav-link active" href="#pat_appointments" data-toggle="tab">My Appointments</a>
											</li>
										</ul>
									</nav>
									<!-- /Tab Menu -->
...
$query = "SELECT * FROM users,appointments where appointments.patient_id=" . $_SESSION["user_id"] . " and appointments.patient_id=users.user_id";
        ...
        //find doc
        $docFindQuery = "SELECT * FROM users,user_profile where users.user_profile_id=user_profile.user_profile_id and  users.user_id=".$row["doctor_id"]."";
		$docResult = $conn->query($docFindQuery);
...
<td>
    <h2 class="table-avatar">
        <a class="avatar avatar-sm mr-2">
            <img class="avatar-img rounded-circle" src="'.$doc["profile_url"].'" alt="User Image">
        </a>
        <a>Dr. '.$doc["first_name"]." ".$doc["last_name"].'<span>'.$doc["title"].'</span></a>
    </h2>
</td>
<td>'.date("M j, Y",strtotime($row["appointment_datetime"])).' <span class="d-block text-info">'.date("h:i A",strtotime($row["appointment_datetime"])).'</span></td>
<td><span class="badge badge-pill bg-success-light">Confirmed</span></td>
<td class="text-right">
    <div class="table-action">
       
        <a target="_blank" href="http://maps.google.com/maps?q='.$doc["address"].'" class="btn btn-sm bg-info-light">
